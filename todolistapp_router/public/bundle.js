    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$1, 27, 68, 961);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "3");
    			add_location(textarea, file$1, 29, 8, 1000);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$1, 24, 6, 780);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-default");
    			add_location(button1, file$1, 32, 8, 1137);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-primary");
    			attr_dev(button2, "data-dismiss", "modal");
    			add_location(button2, file$1, 33, 8, 1231);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$1, 31, 6, 1101);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br1, file$2, 33, 68, 1207);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "3");
    			add_location(textarea, file$2, 35, 8, 1246);
    			attr_dev(input2, "type", "checkbox");
    			add_location(input2, file$2, 36, 15, 1341);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$2, 28, 6, 903);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-default");
    			add_location(button1, file$2, 39, 8, 1463);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-primary");
    			attr_dev(button2, "data-dismiss", "modal");
    			add_location(button2, file$2, 40, 8, 1563);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$2, 38, 6, 1427);
    			attr_dev(div3, "class", "modal-content");
