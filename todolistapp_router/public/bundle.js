var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "aria-hidden", "true");
    			add_location(span, file$2, 25, 109, 755);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "close");
    			attr_dev(button0, "data-dismiss", "modal");
    			attr_dev(button0, "aria-label", "Close");
    			add_location(button0, file$2, 25, 8, 654);
    			attr_dev(h4, "class", "modal-title");
    			add_location(h4, file$2, 26, 8, 813);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$2, 24, 6, 618);
    			attr_dev(input0, "id", "no");
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "name", "no");
    			input0.disabled = true;
    			add_location(input0, file$2, 30, 8, 933);
    			add_location(br0, file$2, 30, 100, 1025);
    			attr_dev(input1, "id", "todo");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "name", "msg");
    			attr_dev(input1, "placeholder", "할일을 여기에 입력!");
    			add_location(input1, file$2, 32, 8, 1057);
    			add_location(br1, file$2, 33, 65, 1185);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "3");
    			add_location(textarea, file$2, 35, 8, 1224);
    			attr_dev(input2, "type", "checkbox");
    			add_location(input2, file$2, 36, 20, 1324);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$2, 28, 6, 884);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-default");
    			add_location(button1, file$2, 39, 8, 1446);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-primary");
    			attr_dev(button2, "data-dismiss", "modal");
    			add_location(button2, file$2, 40, 8, 1543);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$2, 38, 6, 1410);
    			attr_dev(div3, "class", "modal-content");
    			add_location(div3, file$2, 23, 4, 583);
    			attr_dev(div4, "class", "modal-dialog modal-lg");
    			attr_dev(div4, "role", "document");
    			add_location(div4, file$2, 22, 2, 526);
    			attr_dev(div5, "class", "centered-modal fade in");
    			attr_dev(div5, "tabindex", "0");
    			attr_dev(div5, "role", "dialog");
    			add_location(div5, file$2, 21, 0, 459);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<UpdateTodo> was created with unknown prop '${key}'`);
    	});
    ...
    class UpdateTodo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentRoute*/ ctx[3] === undefined && !("currentRoute" in props)) {
    			console_1.warn("<UpdateTodo> was created without expected prop 'currentRoute'");
    		}
    	}
