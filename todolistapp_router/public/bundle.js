var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "추 가";
    			t7 = space();
    			button2 = element("button");
    			button2.textContent = "취 소";
    			attr_dev(span, "aria-hidden", "true");
    			add_location(span, file$1, 21, 109, 644);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "close");
    			attr_dev(button0, "data-dismiss", "modal");
    			attr_dev(button0, "aria-label", "Close");
    			add_location(button0, file$1, 21, 8, 543);
    			attr_dev(h4, "class", "modal-title");
    			add_location(h4, file$1, 22, 8, 702);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$1, 20, 6, 507);
    			attr_dev(input, "id", "msg");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "form-control");
    			attr_dev(input, "name", "msg");
    			attr_dev(input, "placeholder", "할일을 여기에 입력!");
    			add_location(input, file$1, 26, 8, 807);
    			add_location(br, file$1, 27, 65, 934);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$1, 24, 6, 758);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-default");
    			add_location(button1, file$1, 30, 8, 997);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-primary");
    			attr_dev(button2, "data-dismiss", "modal");
    			add_location(button2, file$1, 31, 8, 1091);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$1, 29, 6, 961);
    			attr_dev(div3, "class", "modal-content");
    			add_location(div3, file$1, 19, 4, 472);
    			attr_dev(div4, "class", "modal-dialog modal-lg");
    			attr_dev(div4, "role", "document");
    			add_location(div4, file$1, 18, 2, 415);
    			...
    			add_location(div5, file$1, 17, 0, 311);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	return [todoitem, addTodoHandler, cancelHandler, $state, input_input_handler];
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			button1 = element("button");
    			button1.textContent = "수 정";
    			t9 = space();
    			button2 = element("button");
    			button2.textContent = "취 소";
    			attr_dev(span, "aria-hidden", "true");
    			add_location(span, file$2, 20, 109, 614);
    			attr_dev(button0, "type", "button");
    			attr_dev(button0, "class", "close");
    			attr_dev(button0, "data-dismiss", "modal");
    			attr_dev(button0, "aria-label", "Close");
    			add_location(button0, file$2, 20, 8, 513);
    			attr_dev(h4, "class", "modal-title");
    			add_location(h4, file$2, 21, 8, 672);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$2, 19, 6, 477);
    			attr_dev(input0, "id", "no");
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "name", "no");
    			input0.disabled = true;
    			add_location(input0, file$2, 25, 8, 781);
    			add_location(br0, file$2, 25, 100, 873);
    			attr_dev(input1, "id", "todo");
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "name", "msg");
    			attr_dev(input1, "placeholder", "할일을 여기에 입력!");
    			add_location(input1, file$2, 27, 8, 903);
    			add_location(br1, file$2, 28, 65, 1031);
    			attr_dev(input2, "type", "checkbox");
    			add_location(input2, file$2, 29, 16, 1054);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$2, 23, 6, 732);
    			attr_dev(button1, "type", "button");
    			attr_dev(button1, "class", "btn btn-default");
    			add_location(button1, file$2, 32, 8, 1174);
    			attr_dev(button2, "type", "button");
    			attr_dev(button2, "class", "btn btn-primary");
    			attr_dev(button2, "data-dismiss", "modal");
    			add_location(button2, file$2, 33, 8, 1271);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$2, 31, 6, 1138);
    			attr_dev(div3, "class", "modal-content");
    			add_location(div3, file$2, 18, 4, 442);
    			attr_dev(div4, "class", "modal-dialog modal-lg");
    			attr_dev(div4, "role", "document");
    			add_location(div4, file$2, 17, 2, 385);
    			attr_dev(div5, "class", "centered-modal fade in");
    			attr_dev(div5, "tabindex", "0");
    			attr_dev(div5, "role", "dialog");
    			add_location(div5, file$2, 16, 0, 318);
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input2, /*todoitem*/ ctx[0].done);
    			append_dev(div3, t7);
    			append_dev(div3, div2);
    			append_dev(div2, button1);
    			append_dev(div2, t9);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$3, 25, 4, 514);
    			attr_dev(span1, "class", "pull-right badge pointer");
    			add_location(span1, file$3, 32, 4, 704);
    			attr_dev(span2, "class", "pull-right badge pointer");
    			add_location(span2, file$3, 33, 4, 783);
    			attr_dev(li, "class", /*itemClassName*/ ctx[1]);
    			add_location(li, file$3, 24, 0, 482);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 19, 8, 428);
    			attr_dev(div1, "class", "well");
    			add_location(div1, file$4, 18, 4, 400);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$4, 23, 4, 510);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$4, 26, 8, 674);
    			attr_dev(div3, "class", "panel-body");
    			add_location(div3, file$4, 25, 4, 640);
    			attr_dev(div4, "class", "panel panel-default panel-borderless");
    			add_location(div4, file$4, 24, 4, 584);
    			attr_dev(div5, "class", "container");
    			add_location(div5, file$4, 17, 0, 371);
